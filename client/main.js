        ...
        if (response.length == 0) {
            ...
            response.forEach(list => {
                ...
                if (list.status == false) {
                    label = `<label>
                                <input type="checkbox" class="custom-control-input" onclick="update('${list._id}')"/>
                                <span>Uncompleted</span>
                              </label>`
                } else {
                    label = `<label>
                                <input type="checkbox" class="custom-control-input" onclick="update('${list._id}') checked"/>
                                <span>Completed</span>
                            </label>`
                }
                ...
                $('#todo-content').append(
                    `<tr>
                        ...
                        <td>${list.dueTime}</td>
                        <td> <a class="btn-floating btn-small waves-effect waves-light red" onclick="deleteTodo('${list._id}')"><i class="material-icons">X</i></a></td>
                    </tr>`
                )
            })
